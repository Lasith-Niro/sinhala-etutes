 ...
 * Time: 5:33 PM
 */
$title="Shell Scripting (Lesson 3)"
?>
<html>
<head>
            ...
            <div class="row">
                <article class="span8">
                    <div class="inner-1">
                        <ul class="list-blog">
                            <li>
                                <h2><span style="color: #c62828">Linux Shell Scripting – Lesson 03.</font></span></h2>
                                <h3><span class="label label-success">Permissions</span></h3><br/>
                                ...
                                <img src="data/03/permission1.jpg"/><br/><br/>
                                <img src="data/03/permission2.jpg"/><br/>
                                
                    <nav>
                        <ul class="pager">
                            <li class="pager-prev"><a href="shell_lesson_2.php">Older</a></li>
                            <li class="pager-next"><a href="shell_lesson_4.php">Newer</a></li>
                        </ul>
                    </nav>
                </article>
                <br/>
